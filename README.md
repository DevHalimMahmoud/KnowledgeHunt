...
knowledge Hunt is a platform for all developers to share their knowledge by writing technical articles
or ask questions and get answers from other developers, test their knowledge in any field in
the MCQ section and get a score the user can join coding contests and solve them and the answer is validated on the server compiler 

#### stack overflow and medium and plursight MCQ test and LeetCode problems in one app :) 
